  ...
  private initializeSampleData(): void {
    ...
    const sampleLocations: WaterLocation[] = [
      ...
      },
      {
        ...
        positiveFeedback: 12,
        negativeFeedback: 8,
        voteHistory: this.generateVoteHistory(12, 8, 15, false), // Mixed feedback
        createdAt: new Date(now.getTime() - 15 * 24 * 60 * 60 * 1000).toISOString(),
        updatedAt: now.toISOString(),
      },
      {
        id: 'loc-6',
        type: WaterLocationType.Other,
        latitude: 42.6985,
        longitude: 23.3232,
        osmId: 'node/6789012',
        osmType: 'drinking_water',
